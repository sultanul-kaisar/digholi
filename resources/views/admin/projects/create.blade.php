            ...
            <div class="col-lg-0">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!"></a> Add Projects</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="card sale-card" style="min-height:550px!important;">
                                ...
                                <div class="page-body">
                                    <div class="card-block">
                                        <form method="POST" id="submit-form" action="{{ route('project.store')}}" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="project_category_id" id="" class="form-control select-search @error('project_category_id') is-invalid @enderror">
                                                        ...
                                                        @foreach($categories as $category)
                                                            <option value="{{ $category->id }}" {{ (old('project_category_id') ==  $category->id) ? 'selected=selected':'' }}>{{ $category->title }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="url" class="form-control @error('url') is-invalid @enderror" placeholder="Enter Youtube or Vimeo URL" value="{{ old('url') }}">
                                                    @error('url')
                                                    <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
