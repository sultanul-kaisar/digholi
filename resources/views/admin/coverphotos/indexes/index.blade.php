            ...
            <div class="col-lg-0">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!"></a> About Index</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-12 col-xl-12">
                            <div class="card sale-card" style="min-height:550px!important;">
                                <div class="card-header">
                                    <h5 class="card-title">All Index Photos</h5>
                                        <div class="card-header-right col-md-9">
                                            <a type="button" href="{{ route('index.create') }}" class="btn btn-round waves-effect waves-light btn-primary btn-outline-primary float-right"><i class="icofont icofont-user-alt-3"></i> New index photo</a>
                                        </div>
                                </div>
                                                ...
                                                <div class="content" >
                                                    ...
                                                    @foreach($indexes as $index)
                                                        <tr>
                                                                ...
                                                                <div class="list-icons">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right custom-dropdown-menu-right">
                                                                            <a href="#" class="dropdown-item" onclick="event.preventDefault();getIndex('{{ $index->id }}', '{{ $index->title }}', '{{ $index->image }}', '{{ asset('public/storage/uploads/coverphotos/indexes/') }}', '{{ $index->status }}');"><i class="ti-pencil-alt"></i> View</a>

                                                                            <a href="{{ route('index.edit', $index->id) }}" class="dropdown-item"><i class="ti-pencil-alt"></i> Edit</a>

                                                                            <a href="{{ route('admin.dashboard') }}" class="dropdown-item" onclick="event.preventDefault();document.getElementById('delete-form{{$index->id}}').submit();"><i class="ti-trash"></i> Delete</a>
                                                                            <form id="delete-form{{$index->id}}" action="{{ route('index.destroy', $index->id) }}" method="POST" style="display: none;">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                            </form>
                                                                        </div>
                                                            ...
                                                            <td>{!! $index->title !!}</td>
                                                            <td style="width:15%;">
                                                                <a href="{{ asset('public/storage/uploads/coverphotos/indexes/'.$index->image) }}" data-toggle="lightbox">
                                                                    <img src="{{ asset('public/storage/uploads/coverphotos/indexes/'.$index->image) }}" class="img-fluid">
                                                                </a>
                                                            </td>
                                                            <td>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <table class="table table-bordered">
                                                                <tr>
                                                                    <th>Title</th>
                                                                    <td id="index-title"></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Image</th>
                                                                    <td id="index-image"></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Status</th>
...
@push('js')
    ...
    <script>
        function getIndex(id, title, image, image_path , status)
        {
            ...
            document.getElementById("index-image").innerHTML   = image;
            document.getElementById("index-status").innerHTML  = status;
