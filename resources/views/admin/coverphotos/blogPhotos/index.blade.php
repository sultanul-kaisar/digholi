                                                                ...
                                                                <div class="list-icons">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right custom-dropdown-menu-right">
                                                                            <a href="#" class="dropdown-item" onclick="event.preventDefault();getClient('{{ $slider->id }}', '{{ $slider->title }}', {{ $slider->title2 }}, {{ $slider->title3 }}, {{ $slider->body }}, '{{ $slider->image }}', '{{ asset('public/storage/uploads/coverphotos/sliders/') }}', '{{ $slider->align }}', '{{ $slider->status }}');"><i class="ti-pencil-alt"></i> View</a>
