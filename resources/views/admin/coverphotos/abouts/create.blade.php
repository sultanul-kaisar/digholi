            ...
            <div class="col-lg-0">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!"></a> Add About Photo</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-12 col-xl-12">
                            <div class="card sale-card" style="min-height:550px!important;">
                                <div class="card-header">
                                    <h4>Add about Photo</h4>
                                    <div class="card-header-right col-md-9">
                                        <a type="button" href="{{ route('about.index') }}" class="btn btn-round waves-effect waves-light btn-primary btn-outline-primary float-right ml-2"><i class="ti-angle-double-left"></i> Back</a>
                                ...
                                <div class="card-body">
                                    <form method="POST" id="submit-form" action="{{ route('about.store')}}" enctype="multipart/form-data">
                                        @csrf
