            ...
            <div class="col-lg-0">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#"></a>slider Photo</li>
                        <span class="breadcrumb-item active">slider Photo {{ $slider->id }}</span>
                    </ul>
                </div>
            </div>
        </div>
                                        ...
                                        @if(!is_null($slider->image))
                                            <div class="row mb-3">
                                                <div class="col-9 offset-2">
                                                    <img src="{{ asset('public/storage/uploads/coverphotos/sliders/'. $slider->image) }}" class="img-fluid" style="width:20%;">
                                                </div>
                                            </div>
                                        @endif
                                    </form>
