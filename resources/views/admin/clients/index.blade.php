                                                ...
                                                <div class="content" >
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right custom-dropdown-menu-right">
                                                                                @if(auth()->user()->can('master') || auth()->user()->can('global') || auth()->user()->can('client view'))
                                                                                    <a href="#" class="dropdown-item" onclick="event.preventDefault();getClient('{{ $client->id }}', '{{ $client->title }}', '{{ $client->image }}', '{{ asset('public/storage/uploads/clients/') }}', '{{ $client->url }}', '{{ $client->description }}', '{{ $client->status }}');"><i class="ti-pencil-alt"></i> View</a>
                                                                                @endif
                                                            ...
                                                            <td>{{ $client->title }}</td>
                                                            <td style="width:15%;">
                                                                <a href="{{ asset('public/storage/uploads/clients/'.$client->image) }}" data-toggle="lightbox">
                                                                    <img src="{{ asset('public/storage/uploads/clients/'.$client->image) }}" class="img-fluid">
                                                                </a>
                                                            </td>
                                                            <td>
