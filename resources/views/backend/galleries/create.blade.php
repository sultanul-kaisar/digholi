            ...
            <div class="col-lg-0">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!"></a> Add Galleries</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="card sale-card" style="min-height:550px!important;">
                                ...
                                <div class="page-body">
                                    <div class="card-block">
                                        <form method="POST" id="submit-form" action="{{ route('gallery.store')}}" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="col-lg-9">
                                                    <select name="gallery_category_id" id="" class="form-control select-search @error('gallery_category_id') is-invalid @enderror">
                                                        ...
                                                        @foreach($categories as $category)
                                                            <option value="{{ $category->id }}" {{ (old('gallery_category_id') ==  $category->id) ? 'selected=selected':'' }}>{{ $category->title }}</option>
                                                        @endforeach
                                                    </select>
