                                ...
                                <div class="card-header">
                                    ...
                                    @if(auth()->user()->can('master') || auth()->user()->can('global') || auth()->user()->can('user create'))
                                        <div class="card-header-right col-md-9">
                                            <a type="button" href="{{route('user.create')}}" class="btn btn-round waves-effect waves-light btn-primary btn-outline-primary float-right"><i class="icofont icofont-user-alt-3"></i>New User</a>
                                        </div>
                                    @endif
                                </div>
                                <div class="page-body">
