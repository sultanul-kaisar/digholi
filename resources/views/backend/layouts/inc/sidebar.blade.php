        ...
        <div class="pcoded-inner-navbar main-menu">
            @if(auth()->user()->hasrole('developer'))
                ...
                <li class="pcoded-hasmenu  pcoded-trigger">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="">
                            <a href="{{ route('form') }}" class="nav-link {{ (request()->is('systemcontrol/form')) ? 'active' : ''}} waves-effect waves-dark">
                                <span class="pcoded-mtext">Basic Form</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{ route('table') }}" class="nav-link {{ (request()->is('systemcontrol/table')) ? 'active' : ''}} waves-effect waves-dark">
                                <span class="pcoded-mtext">Basic Data Table</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="{{ route('report-table') }}" class="nav-link {{ (request()->is('systemcontrol/report-table')) ? 'active' : ''}} waves-effect waves-dark">
            ...
            <ul class="pcoded-item pcoded-left-item">
                ...
                @if(auth()->user()->can('master') || auth()->user()->can('global') || auth()->user()->can('contacts view') || auth()->user()->can('contacts delete'))
                    <li class=" ">
                        <a href="{{route('contacts.index')}}" class="nav-link {{ (request()->is('systemcontrol/contacts*')) ? 'active' : ''}}" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
                ...
                @if(auth()->user()->hasrole('developer'))
                    <li class="pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li class=" ">
                                <a href="{{ route('item-category.index') }}"  class="waves-effect waves-dark {{ (request()->is('systemcontrol/item-category*')) ? 'active' : ''}}">
                                    <span class="pcoded-mtext">Categories</span>
                                </a>
                            </li>
                            @endif
                ...
                @if(auth()->user()->can('master') || auth()->user()->can('global') || auth()->user()->can('project category view') || auth()->user()->can('project category create') || auth()->user()->can('project category edit') || auth()->user()->can('project category delete'))
                    <li class="pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=" ">
                                <a href="{{ route('project.index') }}" class="waves-effect waves-dark nav-link {{ (request()->is('systemcontrol/project*')) ? 'active' : ''}}">
                                    <span class="pcoded-mtext">Project</span>
                                </a>
                            </li>
                            @if(auth()->user()->can('master') || auth()->user()->can('global') || auth()->user()->can('project category view') || auth()->user()->can('project category create') || auth()->user()->can('project category edit') || auth()->user()->can('project category delete'))
                                <li class=" ">
                                    <a href="{{ route('project-category.index') }}" class="waves-effect waves-dark nav-link {{ (request()->is('systemcontrol/project-category*')) ? 'active' : ''}}">
                                        <span class="pcoded-mtext">Categories</span>
                                    </a>
                                </li>
                            @endif
                ...
                @if(auth()->user()->can('master') || auth()->user()->can('global') || auth()->user()->can('gallery view') || auth()->user()->can('gallery create') || auth()->user()->can('gallery edit') || auth()->user()->can('gallery delete') || auth()->user()->can('gallery category view') || auth()->user()->can('gallery category create') || auth()->user()->can('gallery category edit') || auth()->user()->can('gallery category delete'))
                    <li class="pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=" ">
                                <a href="{{route('gallery.index')}}" class="waves-effect waves-dark nav-link {{ (request()->is('systemcontrol/gallery*')) ? 'active' : ''}}">
                                    <span class="pcoded-mtext">Gallery</span>
                                </a>
                            </li>
                            @if(auth()->user()->can('master') || auth()->user()->can('global') || auth()->user()->can('gallery category view') || auth()->user()->can('gallery category create') || auth()->user()->can('gallery category edit') || auth()->user()->can('gallery category delete'))
                                <li class=" ">
                                    <a href="{{ route('gallery-category.index') }}" class="waves-effect waves-dark nav-link {{ (request()->is('systemcontrol/gallery-category*')) ? 'active' : ''}}">
                                        <span class="pcoded-mtext">Categories</span>
                                    </a>
                                </li>
                            @endif
                ...
                @if(auth()->user()->can('master') || auth()->user()->can('global') || auth()->user()->can('team view') || auth()->user()->can('team create') || auth()->user()->can('team edit') || auth()->user()->can('team delete') || auth()->user()->can('team department view') || auth()->user()->can('team department create') || auth()->user()->can('team department edit') || auth()->user()->can('team department delete'))
                    <li class="pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=" ">
                                <a href="{{ route('team.index') }}" class="waves-effect waves-dark  {{ (request()->is('systemcontrol/team') || request()->is('systemcontrol/team/*')) ? 'active' : ''}}">
                ...
                @if(auth()->user()->can('master') || auth()->user()->can('global') || auth()->user()->can('slider view') || auth()->user()->can('slider create') || auth()->user()->can('slider edit') || auth()->user()->can('slider delete'))
                    <li class=" ">
                        <a href="{{route('slider.index')}}" class="nav-link {{ (request()->is('systemcontrol/slider*')) ? 'active' : ''}}" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
                ...
                @if(auth()->user()->can('master') || auth()->user()->can('global') || auth()->user()->can('comment view') || auth()->user()->can('comment create') || auth()->user()->can('comment edit') || auth()->user()->can('comment delete'))
                    <li class=" ">
                        <a href="{{route('comment.index')}}" class="nav-link {{ (request()->is('systemcontrol/comment*')) ? 'active' : ''}}" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
                ...
                @if(auth()->user()->can('master') || auth()->user()->can('global') || auth()->user()->can('client view') || auth()->user()->can('client create') || auth()->user()->can('client edit') || auth()->user()->can('client delete'))
                    <li class=" ">
                        <a href="{{ route('client.index') }}" class="nav-link {{ (request()->is('systemcontrol/client*')) ? 'active' : ''}}" class="waves-effect waves-dark">
                                                <span class="pcoded-micon">
                    ...
                    <li class="pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li class=" pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    <li class="">
                                        <a href="{{ route('user.index') }}" class="nav-link {{ (request()->is('systemcontrol/user*')) ? 'active' : ''}}" style="padding: .625rem 1.25rem 0.625rem 2.5rem!important;">
                                            <span class="pcoded-mtext">Users</span>
                                        </a>
                                    </li>
                                        <li class="">
                                            <a href="{{ route('role.index') }}" class="waves-effect waves-dark nav-link {{ (request()->is('systemcontrol/role*')) ? 'active' : ''}}" style="padding: .625rem 1.25rem 0.625rem 2.5rem!important;">
                                                <span class="pcoded-mtext">Roles</span>
                                            </a>
                                        </li>
                                    @if(auth()->user()->hasrole('developer'))
                                        <li class="">
                                            <a href="{{ route('permission.index') }}" class="waves-effect waves-dark nav-link {{ (request()->is('systemcontrol/permission*')) ? 'active' : ''}}" style="padding: .625rem 1.25rem 0.625rem 2.5rem!important;">
