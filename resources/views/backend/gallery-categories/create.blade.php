            ...
            <div class="col-lg-0">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!"></a> Create Gallery Category</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-12 col-xl-12">
                            <div class="card sale-card" style="min-height:550px!important;">
                                <div class="card-header">
                                    <h5 class="card-title">Create Gallery Category</h5>
                                ...
                                <div class="page-body">
                                    <div class="card-block">
                                        <form method="POST" id="submit-form" action="{{ route('gallery-category.store')}}" enctype="multipart/form-data">
                                            @csrf
